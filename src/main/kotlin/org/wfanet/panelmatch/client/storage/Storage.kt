...
// TODO: add this as a method to StorageClient.kt as StorageClient.Blob.foldBlob
suspend fun foldBlob(blob: Blob?): ByteString =
  blob!!.read().fold(ByteString.EMPTY, { agg, chunk -> agg.concat(chunk) })
