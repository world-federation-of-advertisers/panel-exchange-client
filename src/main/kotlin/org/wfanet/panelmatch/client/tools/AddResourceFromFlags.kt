...
private class AddPrivateStorageInfoCommand : Callable<Int> {
  ...
  override fun call(): Int {
    val storageDetails = StorageDetails.parseFrom(privateStorageInfo.readBytes().toByteString())
...
private class AddSharedStorageInfoCommand : Callable<Int> {
  ...
  override fun call(): Int {
    val storageDetails = StorageDetails.parseFrom(sharedStorageInfo.readBytes().toByteString())
