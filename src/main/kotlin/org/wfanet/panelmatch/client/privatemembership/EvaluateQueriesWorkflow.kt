...
private class ExecuteQueriesForShardFn(
  ...
  private val querySizeDistribution = Metrics.distribution(metricsClass, "query-sizes")
  private val shardSizeDistribution = Metrics.distribution(metricsClass, "database-shard-sizes")
  ...
  private fun validateAndCountInputs(
    ...
    shardSizeDistribution.update(shardSize)
    querySizeDistribution.update(queriesSize)
