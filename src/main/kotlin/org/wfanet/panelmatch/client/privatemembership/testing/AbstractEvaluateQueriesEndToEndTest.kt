...
abstract class AbstractEvaluateQueriesEndToEndTest : BeamTestBase() {
  ...
  abstract fun makeQueryEvaluator(parameters: WorkflowParameters): QueryEvaluator

  /** Provides a helper for the test subject. */
  abstract fun makeHelper(parameters: WorkflowParameters): QueryEvaluatorTestHelper
  ...
  private fun runEndToEndTest(parameters: WorkflowParameters) {
