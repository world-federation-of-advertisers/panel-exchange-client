...
fun Pipeline.registerPirCoders() {
  ...
  val queryMetadataCoder =
    addCoder(
      ::QueryMetadata,
      QueryMetadata::queryId to queryIdCoder,
      QueryMetadata::metadata to byteStringCoder
    )
  ...
  addCoder(
    ...
    QueryBundle::queryMetadata to ListCoder.of(queryMetadataCoder),
  ...
  addCoder(::Result, Result::queryMetadata to queryMetadataCoder, Result::data to byteStringCoder)
}
