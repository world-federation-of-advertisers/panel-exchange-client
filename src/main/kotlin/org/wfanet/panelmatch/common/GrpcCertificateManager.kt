...
class GrpcCertificateManager(
  ...
  private val cache = ConcurrentHashMap<Pair<String, String>, Pair<X509Certificate, String>>()

  override suspend fun getCertificate(
    exchangeKey: ExchangeKey,
    certOwnerName: String,
    certResourceName: String
  ): Pair<X509Certificate, String> {
    return cache.getOrPut((certOwnerName to exchangeKey.toName())) {
      ...
      x509.verify(rootCert.publicKey, jceProvider)
      (x509 to certResourceName)
    }
  }
