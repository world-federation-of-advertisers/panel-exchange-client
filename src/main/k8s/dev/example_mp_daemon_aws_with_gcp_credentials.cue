...
// TODO(jmolle): add more docs on how to set up and common pitfalls.
// For directions on how to set this up, refer to deployment docs and
// https://cloud.google.com/iam/docs/workload-identity-federation-with-other-clouds
let EnvVars = #EnvVarMap & {
	"GOOGLE_APPLICATION_CREDENTIALS": {
		value: string @tag("gcp_credentials_path")
	}
}
