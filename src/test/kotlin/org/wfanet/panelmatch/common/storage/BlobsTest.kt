...
class BlobsTest {
  ...
  @Test
  fun toByteStringConcatenatesBlobContents() = runBlockingTest {
    assertThat(mockBlob.toByteString()).isEqualTo("catdogfox".toByteStringUtf8())
  }

  @Test
  fun toStringUtf8ConcatenatesBlobContents() = runBlockingTest {
    assertThat(mockBlob.toStringUtf8()).isEqualTo("catdogfox")
  }

  @Test
  fun newInputStreamReadsEntireBlob() = runBlockingTest {
