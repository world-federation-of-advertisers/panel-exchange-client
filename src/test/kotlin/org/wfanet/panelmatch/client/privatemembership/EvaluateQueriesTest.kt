...
class EvaluateQueriesTest : BeamTestBase() {
  ...
  fun `single EncryptedQueryBundle`() {
    ...
    val parameters =
      WorkflowParameters(numShards = 2, numBucketsPerShard = 5, maxQueriesPerShard = 5)
  ...
  fun `multiple shards`() {
    ...
    //  - Shard 1 to have buckets 0 with "ghi", 1 with "abc", and 2 with "jkl"
    val parameters =
      WorkflowParameters(numShards = 2, numBucketsPerShard = 5, maxQueriesPerShard = 10)
  ...
  fun `repeated bucket`() {
    val parameters =
      WorkflowParameters(numShards = 1, numBucketsPerShard = 1, maxQueriesPerShard = 1)
  ...
  fun `too many queries per shard`() {
    ...
    //  - Shard 1 to have buckets 0 with "ghi", 1 with "abc", and 2 with "jkl"
    val parameters =
      WorkflowParameters(numShards = 2, numBucketsPerShard = 5, maxQueriesPerShard = 2)
