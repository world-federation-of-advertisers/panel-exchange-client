...
class FakeJoinKeyCryptorTest : AbstractJoinKeyCryptorTest() {
  override val cipher: JoinKeyCryptor = FakeJoinKeyCryptor
  override val invalidKey: ByteString = FakeJoinKeyCryptor.INVALID_KEY
