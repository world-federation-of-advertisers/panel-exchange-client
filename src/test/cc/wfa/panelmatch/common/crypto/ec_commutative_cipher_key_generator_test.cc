...
// Make sure GenerateKey returns a uvalue that can be used to create an ECCommutativeCipher
TEST(EcCommutativeCipherKeyGeneratorTest, createEcCommutativeCipher) {
  ...
  ASSERT_OK_AND_ASSIGN(std::unique_ptr<ECCommutativeCipher> cipher,
     ECCommutativeCipher::CreateFromKey(NID_X9_62_prime256v1, SecretDataAsStringView(key),
